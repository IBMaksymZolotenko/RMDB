...
BEGIN TRY
	...
	SET	@SQL		=	
		'
			...
			SELECT  --GREATEST(NVL(V1.MAX_DPD_LAST_24MON,0),NVL(V1.MAX_DPD8,0))								AS  MAX_DPD_LAST_24_MON,
					NVL(V1.MAX_DPD_LAST_24MON,0)															AS  MAX_DPD_LAST_24_MON,
					...
					/*CASE WHEN V1.FIRST_LOAN_MON_CNT < 0 THEN 0
						ELSE V1.FIRST_LOAN_MON_CNT
